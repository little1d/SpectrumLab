from spectrumlab.models import Grok_2_Vision
...
def test_grok_2_vision_text_generation():
    model = Grok_2_Vision()
...
def test_grok_2_vision_multimodal_generation():
    model = Grok_2_Vision()
...
def test_grok_2_vision_signalgroup_evaluation():
    model = Grok_2_Vision()
