from spectrumlab.models import Llama_Vision_11B
...
def test_llama_vision_11b_multimodal_generation():
    model = Llama_Vision_11B()
...
def test_llama_vision_11b_signalgroup_evaluation():
    model = Llama_Vision_11B()
